...
def print_intro():
    ...
    print(
        " ..You wake up with a throbbing ache \n"
...
def print_board(board):
    """Print the board with numbers as columns and letters as rows."""
    print(" ", " ".join("12345"))
...
def shoot():
    """Ask the player for an input (A5) and validate it."""
    while True:
        guess = (
            input(
                "Aim the cannons!!! (e.g. A5) \n"
...
def check_hit(hidden_board, player_board, row, col):
    """Check if the guessed input was a hit or a miss."""
